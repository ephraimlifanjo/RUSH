...
& $python -m PyInstaller --noconfirm --clean --onefile --name rush-office-engine --distpath $dest --workpath "$env:TEMP\rush-pyinstaller" --specpath "$env:TEMP\rush-pyinstaller-spec" ".\python\engine.py"
